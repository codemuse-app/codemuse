  ...
  export class Index extends pb_1.Message {
    ...
    toObject() {
      ...
      if (this.documents != null) {
        data.documents = this.documents.map((item: Document) =>
          item.toObject()
        );
      }
  ...
  export class SymbolInformation extends pb_1.Message {
    ...
    constructor(
      ...
      if (!Array.isArray(data) && typeof data === "object") {
        ...
        if (
          "signature_documentation" in data &&
          data.signature_documentation != undefined
        ) {
    ...
    static fromObject(data: {
      ...
      if (data.signature_documentation != null) {
        message.signature_documentation = Document.fromObject(
          data.signature_documentation
        );
      }
    ...
    toObject() {
      const data: {
        ...
        kind?: SymbolInformation.Kind;
        display_name?: string;
        signature_documentation?: ReturnType<
          typeof Document.prototype.toObject
        >;
        enclosing_symbol?: string;
      } = {};
      if (this.symbol != null) {
  ...
  export class Occurrence extends pb_1.Message {
    ...
    static fromObject(data: {
      ...
      if (data.diagnostics != null) {
        message.diagnostics = data.diagnostics.map((item) =>
          Diagnostic.fromObject(item)
        );
      }
    ...
    toObject() {
      ...
      if (this.diagnostics != null) {
        data.diagnostics = this.diagnostics.map((item: Diagnostic) =>
          item.toObject()
        );
      }
